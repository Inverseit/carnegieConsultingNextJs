...
const ForRecs = () => {
    return (
        <>
            <div className="what-we-do-area ptb-100" id="for-recs">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-md-12">
                            <div className="what-we-do-content">
                                <span className="sub-title">FOR RECRUITERS</span>
                                ...
                                <Tabs>
                                    <TabList>
                                        ...
                                        <Tab>Information Sessions </Tab>
                                        <Tab>Business Discussions</Tab>
                                    </TabList>
